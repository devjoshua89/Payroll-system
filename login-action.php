...
<body>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 theme-bg border-bottom shadow-md">
        <a class="navbar-brand brand-light my-0 mr-md-auto" href="signup.php">
            Payroll
        </a>
      </div>
          ...
          <div class="col-8 mx-auto">
                ...
                <div class="shadow-lg bg-white mt-4 rounded">
                    <div class="col text-center p-3">
                        <?php
                        $managerid = filter_input(INPUT_GET,'mgrid');
                        ...
                        $sql="SELECT * FROM signup  WHERE mgrid='$_POST[mgrid]' AND pass='$_POST[password]'";
                        $result=mysqli_query($conn,$sql);
                        if(mysqli_num_rows($result)>0){
                            $_SESSION["mgrid"] = $managerid;
