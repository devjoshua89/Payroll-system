                    ...
                    <div class="row align-items-center h-100" >
                        <div class="col-8 mx-auto p-4 login-card shadow-lg rounded">
                            ...
                            <form class="mt-4" action="login-action.php" method="post">
                                ...
                                <input type="text" class="form-control" placeholder="Manager ID" name="manager_id" id="managerID" aria-describedby="emailHelp">
                                </div>
                                <div class="form-group pb-2">
                                ...
                                <p class="mt-4 text-center">Not a Member? <a href="signup.php">Sign Up</a></p>
                            </form>
                        </div>
                    </div>
                </div>
