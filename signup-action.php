                    ...
                    <?php
                       ...
                       mysqli_select_db($conn,"salary");
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo"<p>Manager ID already registered</p>
                            <form action='sign-up.php'><button type='submit' class='btn theme-btn'>Try Again</button></form>";
                        }

                        else {
                            $sql="INSERT INTO signup (name, mgrid, email, phone, Pass) VALUES ('$_POST[name]','$_POST[mgrid]','$_POST[email]','$_POST[phoneno]','$_POST[password]')";
