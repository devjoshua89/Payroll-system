                ...
                <div class="shadow-lg bg-white mt-4">
                    ...
                    <form action="add-employee-action.php" method="post">
                        <div class="form-group mx-4 mt-4">
                            <input type="text" name="employee_name" required class="form-control" placeholder="Name">
                        </div>
                        <div class="form-group mx-4 mt-4">
                            <input type="text" name="employee_id" required class="form-control" placeholder="Employee ID">
                        </div>
                        <div class="form-group mx-4 mt-4">
                            <input type="tel" name="phone_number" required class="form-control"  placeholder="Mobile Number">
                        </div>
                        <div class="form-group mx-4 mt-4">
                            <input type="email" name="email" required class="form-control" placeholder="Email">
                        </div>
                        <div class="form-group mx-4 mt-4">
                            <input type="text" name="employee_address" required class="form-control" placeholder="Address">
                        </div>
                        <div class="form-group mx-4 mt-4">
                        ...
                        <div class="form-group mx-4 mt-4">
                            ...
                            <input type="date" name="date_join"  required class="form-control" placeholder="Date of Joining">
                        </div>
                        <div class="form-group mx-4 mt-4">
